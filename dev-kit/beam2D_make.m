function beam2D_make(target, varargin)
% Build tool for beam2D
%
% beam2D_make <target> [...options...]
%
% This is the main build tool for doing all the build and packaging operations
% for beam2D. It's intended to be called as a command. This is what you will
...
function make_zips
program = "SingleSpanBeam";
distName = program + "-" + beam2D.globals.version;
