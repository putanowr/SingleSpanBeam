function beam2D_make_release(newVersion)
% Cut a release of SingleSpanBeam
%
% beam2D_make_release newVersion
%
...
echo("   https://github.com/putanowr/SingleSpanBeam/releases")
if ismac
  % TODO: Figure out how to do this on Windows and Linux
  system('open "https://github.com/putanowr/SingleSpanBeam/releases"')
end
